...
contract InvariantChecker is AccessControl {
     ...
     */
    function checkVault(uint256 totalAssets, uint256 totalShares) external {
     ...
     */
    function checkSolvency(uint256 assets, uint256 liabilities) external {
     ...
     */
    function checkNoNegativeBalance(address account, int256 balance) external {
        if (balance < 0) {
