...
async function main() {
  console.log("🚀 Deploying Anomaly Detection System (Quick Method)...\n");
  ...
  try {
    ...
    console.error("\nThis is likely due to compilation errors in other contracts.");
    console.error("The anomaly detection contracts are correct but need the full codebase to compile first.");
    console.error("\nNext steps:");
    console.error("1. Fix compilation errors in Layer 3 and Layer 4 contracts");
