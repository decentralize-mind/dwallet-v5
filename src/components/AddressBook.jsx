...
export default function AddressBook({ onSelect }) {
  ...
  const handleSave = () => {
    ...
    if (!isValid(address))  return setError("Invalid address — must be 0x + 40 hex chars");
    ...
    <div className="view-container">
      ...
      {showForm && (
        <div style={{
          ...
          <p style={{fontSize:13,fontWeight:700,margin:"0 0 12px",color:"var(--accent)"}}>
            New contact
          </p>
      ...
      {contacts.length === 0 && !showForm && (
        <div style={{
          ...
          <p style={{fontSize:12,color:"var(--text3)",margin:0,lineHeight:1.6}}>
            Save wallet addresses you send to often — no more copy-pasting long addresses
          </p>
          <button
            ...
            return (
              <div key={c.address} style={{
                ...
                <div style={{
                  ...
                  color,fontSize:17,fontWeight:700,flexShrink:0,
                  display:"flex",alignItems:"center",justifyContent:"center"
                }}>
                ...
                <div style={{flex:1,minWidth:0}}>
                  ...
                  <p style={{
                    fontSize:11,color:"var(--text3)",margin:"3px 0 0",
                ...
                <div style={{display:"flex",gap:6,flexShrink:0}}>
                  ...
                  <button
                    ...
                    style={{
                      background: copied===c.address
                        ? "rgba(16,185,129,0.12)"
                        : "var(--bg3)",
                      color: copied===c.address
                        ? "var(--green)"
                        : "var(--text2)",
                      border: "1px solid " + (copied===c.address
                        ? "rgba(16,185,129,0.3)"
                        : "var(--border)"),
