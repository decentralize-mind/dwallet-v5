...
export default function DAppsView() {
  ...
  return (
    <div className="view-container">
              ...
              {isConnected ? (
                ...
                <div className="dapp-actions">
                  <button
                    ...
                    onClick={() => handleLegacyConnect(dapp)}
                  >
                    Open
                  </button>
                  <button
                    className="btn-wc-small"
      ...
      {showWCModal && (
        <WalletConnectModal onClose={() => setShowWCModal(false)} />
      )}
          ...
          <div className="modal small-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <p className="connect-text">
                <strong>{connecting.name}</strong> is requesting to connect to
                your wallet.
              </p>
              ...
              <div className="btn-row">
                ...
                <button className="btn-primary" onClick={confirmLegacyConnect}>
                  Connect
                </button>
              </div>
            </div>
