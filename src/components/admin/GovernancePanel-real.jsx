...
export default function GovernancePanel() {
  ...
  const fetchTreasuryData = async (ethProvider, networkName) => {
    try {
      ...
      const dwtContract = new ethers.Contract(addresses.DWT, DWT_ABI, ethProvider)
  ...
  const fetchProposals = async (ethProvider, networkName) => {
    try {
      ...
      const governanceContract = new ethers.Contract(addresses.Governance, GOVERNANCE_ABI, ethProvider)
  ...
  const fetchTimelockQueue = async (ethProvider, networkName) => {
    try {
      ...
      const timelockContract = new ethers.Contract(addresses.Timelock, TIMELOCK_ABI, ethProvider)
  ...
  const fetchUserVotingPower = async (ethSigner, networkName) => {
    try {
      ...
      const dwtContract = new ethers.Contract(addresses.DWT, DWT_ABI, ethSigner)
