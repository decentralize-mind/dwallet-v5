...
const KNOWN_TOKENS = {
  ...
  sepolia: [
    {
      symbol: 'DWT',
      address: '0xdF8efd9F36f55baD4c7f38a7c958202858927743',
      name: 'dWallet Token',
    },
  ],
  polygon: [
...
export default function TokenImport({ activeChain, walletAddress, onAdded }) {
  ...
  const handleLookup = async () => {
    ...
    if (!ethers.isAddress(trimmed)) {
      return setError(
        'Invalid address — must start with 0x followed by 40 hex characters',
      )
    }
    setLoading(true)
    ...
    try {
      ...
      if (msg.includes('timeout')) {
        ...
        setError(
          'This address is not a valid ERC-20 token on ' +
            chain +
        ...
        setError(
          'Contract call failed — this may not be an ERC-20 token on ' + chain,
        )
      } else {
        setError(
          'Could not load token — verify the address and network are correct',
        )
      }
    } finally {
      setLoading(false)
    ...
    <div className="view-container">
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            {chain === 'sepolia' && (
              <button
                onClick={() =>
                  handleFill('0xdF8efd9F36f55baD4c7f38a7c958202858927743')
                }
                style={{
                  background: 'none',
                  border: 'none',
              ...
              >
                ...
                >
                  0xdF8efd9F36f55baD4c7f38a7c958202858927743
                </p>
                <p
                  style={{
                    fontSize: 10,
      ...
      {token && (
        ...
        >
          ...
          <button className="btn-primary full-width" onClick={handleAdd}>
